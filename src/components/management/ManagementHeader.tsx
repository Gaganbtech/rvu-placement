      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-white/10">
            <div className="w-8 h-8 rounded-full bg-gold/20 border border-gold/50 flex items-center justify-center text-gold font-bold text-xs">
            ...
            <div className="hidden lg:block text-left">
              ...
              <div className="text-[10px] text-rvu-muted font-mono leading-tight mt-0.5">
                car.placement@rvu.edu.in
              </div>
            </div>
          </div>
